...
public class AppUserAudit {
    ...
    /**
     * 申请为正式用户的状态:1为申请中,2为申请失败,3为申请成功
     */
    ...
    /**
     * 获取申请为正式用户的状态:1为申请中,2为申请失败,3为申请成功
     *
     * @return status - 申请为正式用户的状态:1为申请中,2为申请失败,3为申请成功
     */
    ...
    /**
     * 设置申请为正式用户的状态:1为申请中,2为申请失败,3为申请成功
     *
     * @param status 申请为正式用户的状态:1为申请中,2为申请失败,3为申请成功
     */
